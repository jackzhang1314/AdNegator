...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// 对外可见状态 (Public States - E2B API/SDK)
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// 这些状态通过 API 响应返回给客户端，在 SDK 中可见
const (
    StateRunning SandboxState = "running"  // 运行中 (对外可见)
    StatePaused  SandboxState = "paused"   // 已暂停 (Beta功能，对外可见)
)

// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// 内部状态 (Internal States - Orchestrator Only)
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// 这些状态仅在 Orchestrator 实现层使用，不通过 API 暴露
// GET /sandboxes/{id} 在这些状态下返回 404 或最近的公开状态
const (
    StateCreating    SandboxState = "creating"    // 内部：Firecracker VM 启动中
    StateTerminating SandboxState = "terminating" // 内部：资源清理中
)

// ValidTransitions defines allowed state transitions (对外可见状态)
// 注意：内部状态转换 (creating→running, running→terminating) 不在此映射中
var ValidTransitions = map[SandboxState][]SandboxState{
    StateRunning: {StatePaused},    // running → paused (Beta pause)
    StatePaused:  {StateRunning},   // paused → running (resume via connect)
}

// API 行为说明:
// - GET /sandboxes/{id} 在 creating 状态时可能返回 404 或 running (取决于实现)
// - GET /sandboxes/{id} 在 terminating 状态时返回 404
// - 状态查询仅返回 'running' 或 'paused'
